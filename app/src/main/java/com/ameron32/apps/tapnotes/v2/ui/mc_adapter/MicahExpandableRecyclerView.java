...
import com.levelupstudio.recyclerview.BuildConfig;
import com.levelupstudio.recyclerview.RecyclerViewWithHeader;


/**
 * Created by Micah on 7/31/2015.
 */
public class MicahExpandableRecyclerView extends RecyclerViewWithHeader {
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(MicahExpandableRecyclerView parent, View v, int groupPosition, long id);
    }
     ...
     * within a {@link MicahExpandableRecyclerView}.</p>
     */
    public static abstract class ExpandableAdapter<VH extends ExpandableViewHolder, T> extends Adapter<VH> implements ExpandHandler {
        ...
        private MicahExpandableRecyclerView recyclerView;
         ...
         * (e.g. in a click listener), use {@link MicahExpandableRecyclerView.ExpandableViewHolder#getPosition()} which will have the
         * updated position.
         *
        ...
        void attachRecyclerView(MicahExpandableRecyclerView recyclerView) {
    ...
    public MicahExpandableRecyclerView(Context context) {
        super(context);
        init();
    }

    public MicahExpandableRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MicahExpandableRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (currentItemAnimator != null) {
            ...
            currentItemAnimator.isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                ...
                public void onAnimationsFinished() {
                    ...
                    MicahExpandableRecyclerView.super.setItemAnimator(expandAnimator);
    ...
    private void doExpandAndCollapse(final int expandPosition, final int collapsePosition) {
        ...
        if (collapseChanged || expandedChanged) {
            ...
            ViewCompat.postOnAnimationDelayed(this, new Runnable() {
                @Override
                public void run() {
                    MicahExpandableRecyclerView.super.getItemAnimator().isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                        @Override
                        public void onAnimationsFinished() {
                            if (DEBUG_ANIMATOR)
                            ...
                            MicahExpandableRecyclerView.super.setItemAnimator(mUserItemAnimator);
                        }
                    });
                }
            }, MicahExpandableRecyclerView.super.getItemAnimator().getMoveDuration());
        }
    }
        ...
        if (super.getItemAnimator() == mUserItemAnimator) {
            ...
            super.getItemAnimator().isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                ...
                public void onAnimationsFinished() {
                    ...
                    if (MicahExpandableRecyclerView.super.getItemAnimator() != mUserItemAnimator) {
                        MicahExpandableRecyclerView.super.setItemAnimator(mUserItemAnimator);
                    }
    ...
    static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel in) {
            super((Parcelable)in.readParcelable(RecyclerView.class.getClassLoader()));
